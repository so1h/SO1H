...
(
" extern __stop__bss   \n"
" extern __start       \n"    /* funcion a la que hay que ceder el control */
) ;
...
" uBIOS: db 0xFF       \n"                          /* valor de unidadBIOS */
" calculo3:            \n"
"   mov al,[cs:12]   \n"   /* uBIOS = 12 respecto (unidadBIOS >> 4) << 4 */ 
...
/* Cuando se llama a una función como unidadBIOS el CS:IP se normalizan de */
/* manera que IP valga 0x0000 al principio de la función. Es decir         */
/* CS=((CS0 << 4)+IP0) >> 4 y IP = 0x0000                                  */     