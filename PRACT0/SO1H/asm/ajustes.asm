...
; RPN'ized expression: "CS_SO1H _start_allcode__ &u (something14) <something16> sizeof (something15) - 4 >> (something13) = "
...
; RPN'ized expression: "RO_SO1H _start__rodata &u (something20) 4 >> (something19) = "
...
; loc     <something> : unsigned short
; loc     <something> : unsigned
; RPN'ized expression: "DS_SO1H _start__data &u (something24) 4 >> (something23) = "
...
; loc     <something> : unsigned short
; loc     <something> : unsigned
; RPN'ized expression: "BSS_SO1H _start__bss &u (something28) 4 >> (something27) = "
...
; loc     <something> : unsigned short
; loc     <something> : unsigned
; RPN'ized expression: "SS_SO1H _stop__bss &u (something32) 15 + 4 >> (something31) = "
...
; Ident IMRInicial
; Ident obtenerMapa
; Bytes used: 3760/16384

; Next label number: 36
