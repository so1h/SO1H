...
; Fused expression:    "=(204) *(@-20) 1 "
	mov	eax, 1
	mov	[bp-20], eax
; RPN'ized expression: "lentitud 2 = "
; Expanded expression: "(@-24) 2 =(4) "
; Fused expression:    "=(204) *(@-24) 2 "
	mov	eax, 2
	mov	[bp-24], eax
; RPN'ized expression: "f i 25 % = "
; Expanded expression: "(@-28) (@-4) *(4) 25 % =(4) "
; Fused expression:    "% *(@-4) 25 =(204) *(@-28) ax "
	mov	eax, [bp-4]
	cdq
	mov	ecx, 25
	idiv	ecx
	mov	eax, edx
	mov	[bp-28], eax
; RPN'ized expression: "letra 65 i + = "
; Expanded expression: "(@-40) 65 (@-4) *(4) + =(-1) "
; Fused expression:    "+ 65 *(@-4) =(124) *(@-40) ax "
	mov	eax, 65
	add	eax, [bp-4]
	mov	[bp-40], al
	movsx	eax, al
...
; Fused expression:    "+ *(@-4) *(@-24) % *(@-8) ax == ax 0 IF! "
	...
	jne	L8
; {
; RPN'ized expression: "c k 80 % = "
; Expanded expression: "(@-32) (@-12) *(4) 80 % =(4) "
; Fused expression:    "% *(@-12) 80 =(204) *(@-32) ax "
	mov	eax, [bp-12]
	cdq
	mov	ecx, 80
	idiv	ecx
	mov	eax, edx
	mov	[bp-32], eax
; RPN'ized expression: "cant kant 80 % = "
; Expanded expression: "(@-36) (@-16) *(4) 80 % =(4) "
; Fused expression:    "% *(@-16) 80 =(204) *(@-36) ax "
	mov	eax, [bp-16]
	cdq
	mov	ecx, 80
	idiv	ecx
	mov	eax, edx
	mov	[bp-36], eax
; RPN'ized expression: "ptrPant t -> *u f + *u cant + *u &u car -> *u 32 = "
; Expanded expression: "(@-48) *(4) 0 + (@-28) *(4) 160 * + (@-36) *(4) 2 * + 0 + 32 =(1) "
; Fused expression:    "+ *(@-48) 0 push-ax * *(@-28) 160 + *sp ax push-ax * *(@-36) 2 + *sp ax + ax 0 =(156) *ax 32 "
	mov	eax, [bp-48]
	push	eax
	mov	eax, [bp-28]
	imul	eax, eax, 160
	...
	mov	[si], al
	movzx	eax, al
; RPN'ized expression: "ptrPant t -> *u f + *u cant + *u &u atr -> *u 7 = "
; Expanded expression: "(@-48) *(4) 0 + (@-28) *(4) 160 * + (@-36) *(4) 2 * + 1 + 7 =(1) "
; Fused expression:    "+ *(@-48) 0 push-ax * *(@-28) 160 + *sp ax push-ax * *(@-36) 2 + *sp ax + ax 1 =(156) *ax 7 "
	mov	eax, [bp-48]
	push	eax
	mov	eax, [bp-28]
	imul	eax, eax, 160
...
; Fused expression:    "=(204) *(@-20) -1 "
	mov	eax, -1
	mov	[bp-20], eax
; RPN'ized expression: "k 79 = "
; Expanded expression: "(@-12) 79 =(4) "
; Fused expression:    "=(204) *(@-12) 79 "
	mov	eax, 79
	mov	[bp-12], eax
; }
L10:
...
; Fused expression:    "=(204) *(@-4) 0 "
	...
	mov	[bp-4], eax
L38:
; RPN'ized expression: "i 25 < "
; Expanded expression: "(@-4) *(4) 25 < "
...
; Fused expression:    "=(204) *(@-4) 1 "
	...
	mov	[bp-4], eax
L55:
; RPN'ized expression: "i 25 1 + < "
; Expanded expression: "(@-4) *(4) 26 < "
